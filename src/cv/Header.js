...
const Header = () => {
  return (
    <View style={styles.header}>
      ...
      <Text style={[styles.position, styles.color_blue]}>Senior Frontend Developer</Text>
      <View style={[styles.flex, styles.flexRow, styles.contacts]}>
        <View style={[styles.flex, styles.flexCenter, styles.flexRow, styles.contact]}>
          {Icons.PhoneIcon}
          <Link src="tel:+380631208277" style={[styles.contactText, styles.color_main, styles.fontM]}>+380631208277</Link>
        </View>
        <View style={[styles.flex, styles.flexCenter, styles.flexRow, styles.contact]}>
          {Icons.EmailIcon}
