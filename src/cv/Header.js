  ...
  return (
    <View style={styles.header}>
      ...
      <View style={[styles.flex, styles.flexRow, styles.contacts]}>
        ...
        <View style={[styles.flex, styles.flexCenter, styles.flexRow, styles.contact]}>
          {Icons.EmailIcon}
          <Link src="email:submerged311@gmail.com" style={styles.contactText}>submerged311@gmail.com</Link>
        </View>
        <View style={[styles.flex, styles.flexCenter, styles.flexRow, styles.contactLast]}>
          {Icons.AddressIcon}
          <Text src="tel:+380631208277" style={styles.contactText}>Florida, US (temp)</Text>
        </View>
      </View>
    </View>
  )
